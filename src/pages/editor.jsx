...
import { Collapse,Modal,Form,Table,Button, Radio } from 'antd';
import { Tag,Input,InputNumber,Alert,Select,Checkbox } from 'antd';
import _ from 'lodash';
import ColorPicker from 'rc-color-picker';
import 'rc-color-picker/assets/index.css'
import { CodeViewPage, PropsComp }from './ContainerBox';
import React, { Component } from 'react';
import Antds from '../components';
import { v4 } from 'uuid';
...
class Editor extends Component {
  constructor(props) {
    ...
    var dataSource = localStorage.getItem('cache_data');
    if(dataSource){
      this.state.data = JSON.parse(dataSource);
    }
  ...
  render() {
    ...
    return (
      ...
      >
        <div style={{width:'25vw', height: '100vh', border: "1px solid #000", overflow: "auto"}}>
          <h2 style={{textAlign: 'center', padding: "10px"}}>组件展示区域</h2>
...

        {
          this.state.radioKey === '1' ?
            <div>
              ...
              <div style={{ width: '45vw', height: '100vh', position: 'relative', border: "1px solid #000" }}>
                {
            ...
            <div>
              {
                this.state.radioKey === '2'?
                <CodeViewPage restPage={(e) => this.setState(e)} viewText={this.renderJSONtoJSX()} {...this}/> 
                // <CodeViewPage restPage={(e) => this.setState(e)} {...this}/> 
                :null
              }
            </div>
        }
